...
export default function AddBotToServer({ redirectLoaction }: Params) {
  ...
  // TODO: move this query to serverside
  const { data: botToServerUrl } = useQuery({
  ...
  return (
    <>
      <Card className="w-full max-w-md p-6 shadow-md">
        ...
        <Button onClick={() => verifyBot(serverId)} className="w-full gap-4">
          <svg
