      ...
      <div className="z-10 w-full max-w-5xl  text-sm">
        ...
        >
          ...
          <div className="my-4 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <button className="w-fit rounded-md border border-slate-300 px-6 py-4 font-bold text-slate-300 transition-colors duration-300 hover:border-primary hover:text-primary ">
              <svg
